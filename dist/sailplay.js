...
},{"cssify":1}],6:[function(require,module,exports){
(function () {
...
exports.default = function (messager) {
    return function (params) {
        ...
        this.achiv = _knockout2.default.observableArray([]);
        ...
        _sailplayHub2.default.on('load.badges.list.success', function (result) {
            result.multilevel_badges.forEach(function (arr) {
        ...
        messager.subscribe('init', function (config) {
            _this.config = config;
            _this.update(config);
        });
    };
...
var _sailplayHub = require('sailplay-hub');

var _sailplayHub2 = _interopRequireDefault(_sailplayHub);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

},{"knockout":4,"sailplay-hub":7}],10:[function(require,module,exports){
'use strict';
...
exports.default = function (messager) {
    return function (params) {
        ...
        this.gifts = _knockout2.default.observableArray([]);
        this.userPoints = _knockout2.default.observable();
        ...
        messager.subscribe('user_points', function (points) {
            _this.userPoints(points());
        });

        this.popupVm = {
            opened: _knockout2.default.observable(false),
            width: _knockout2.default.observable('363px'),
            gift: _knockout2.default.observable(),
            points: this.userPoints,
            gift_purchase: function gift_purchase(gift) {
                _sailplayHub2.default.send('gifts.purchase', { gift: gift });
                _sailplayHub2.default.on('gifts.purchase.success', function (result) {
                    _this.popupVm.opened(false);
            ...
            openGift: function openGift(gift) {
                document.body.className += ' no_scrol';
                _this.popupVm.gift(gift);
                _this.popupVm.opened(true);
            }
        };

        messager.subscribe('init', function (config) {
            _this.config = config;
            _sailplayHub2.default.jsonp.get(config.DOMAIN + config.urls.gifts.list, {
                auth_hash: config.auth_hash,
                lang: 'ru'
            }, function (result) {
                _this.gifts(result.gifts);
            });
        });
    };
};
...
},{"knockout":4,"sailplay-hub":7}],11:[function(require,module,exports){
'use strict';
...
exports.default = function (messager) {
    return function (params) {
        ...
        this.update = function (config) {
            if (!config) config = _this.config;
            _sailplayHub2.default.jsonp.get(config.DOMAIN + config.urls.users.history, {
                auth_hash: config.auth_hash
            }, function (result) {
        ...
        this.popupVm = {
            ...
            pages: _knockout2.default.computed(function () {
                return Math.ceil(_this.history().length / 6.0);
            }),
            setPage: function setPage(index) {
                _this.popupVm.current_page(index());
            },
            nextPage: function nextPage() {
                _this.popupVm.current_page(_this.popupVm.current_page() + 1);
            },
            formatDate: this.formatDate,
            checkPoints: this.checkPoints,
            width: _knockout2.default.observable('488px'),
            current_page: _knockout2.default.observable(0),
            openHistory: function openHistory() {
                document.body.className += ' no_scrol';
                _this.popupVm.current_page(0);
                _this.popupVm.opened(true);
            }
        };
    };
...
},{"knockout":4,"sailplay-hub":7}],12:[function(require,module,exports){
'use strict';
...
exports.default = function (messager) {
    return function (params) {
        ...
        this.data = _knockout2.default.observable();
        ...
        this.training_tags = ['Тренировка: 1 раз в неделю или реже', 'Тренировка: 2-3 раза в неделю', 'Тренировка: 4-5 раз в неделю', 'Тренировка: 6 и более раз в неделю'];

        this.registration = ['Пользователь заполнил профиль'];
        this.is_register = _knockout2.default.observable(false);
        this.vars = ['city', 'address', 'child_birthdate', 'game_other'];

        this.update = function (config) {
            if (!config) config = _this.config;
            _sailplayHub2.default.jsonp.get(config.DOMAIN + config.urls.users.info, {
                auth_hash: config.auth_hash,
                all: 1
            }, function (result) {
                var value = _knockout2.default.mapping.fromJS(result);
                ['first_name', 'last_name', 'middle_name'].map(function (el) {
                    value.user[el].extend({ required: true, minLength: 3 });
                });

                if (value.user.birth_date()) {
                    var birth_date = value.user.birth_date();
                    value.user.birth_day = _knockout2.default.observable(birth_date.split('-')[2]).extend({ required: true, min: 1, max: 31, pattern: { message: "wrong", params: '^[0-9]{1,2}$' } });
                    value.user.birth_month = _knockout2.default.observable(_this.popupVm.months().find(function (item) {
                        return item && item.index == birth_date.split('-')[1];
                    })).extend({ required: true });
                    value.user.birth_year = _knockout2.default.observable(birth_date.split('-')[0]).extend({ required: true, min: 1863, pattern: { message: "wrong", params: '^[0-9]{4}$' } });
                } else {
                    value.user.birth_day = _knockout2.default.observable().extend({ required: true, min: 1, max: 31, pattern: { message: "wrong", params: '^[0-9]{1,2}$' } });
                    value.user.birth_month = _knockout2.default.observable().extend({ required: true });
                    value.user.birth_year = _knockout2.default.observable().extend({ required: true, min: 1863, pattern: { message: "wrong", params: '^[0-9]{4}$' } });
                }
                ...
                _sailplayHub2.default.jsonp.get(config.DOMAIN + config.urls.users.custom_variables.batch_get, {
                    names: JSON.stringify(_this.vars),
                    auth_hash: config.auth_hash
                }, function (result) {
                    if (result.vars.length) {
                        _knockout2.default.utils.arrayForEach(result.vars, function (item) {
                            if (item.name == 'child_birthdate') {
                                _this.data().user['child_bday'](item.value.split('-')[2]);
                                _this.data().user['child_bmonth'](_this.popupVm.months().find(function (i) {
                                    return i && i.index == item.value.split('-')[1];
                                }));
                                _this.data().user['child_byear'](item.value.split('-')[0]);
                            } else if (_this.data().user[item.name]) _this.data().user[item.name](item.value);
                        });
                    }
                });

                var tags = [].concat(_this.training_tags, _this.games_tags, _this.for_who_tags, _this.registration),
                    tags_to_process = [];

                while (tags.length) {
                    tags_to_process.push(tags.pop());
                    if (tags_to_process.length == 10 || !tags.length) {
                        _sailplayHub2.default.jsonp.get(config.DOMAIN + config.urls.tags.exist, {
                            auth_hash: config.auth_hash,
                            tags: JSON.stringify(tags_to_process)
                        }, function (result) {
                            _this.registration.forEach(function (item) {
                                var found = result.tags.find(function (t) {
                                    return t.exist && t.name == item;
                                });
                                if (found) _this.is_register(true);
                            });
                            _this.training_tags.forEach(function (item) {
                                var found = result.tags.find(function (t) {
                                    return t.exist && t.name == item;
                                });
                                if (found) _this.data().user['training'](item);
                            });
                            _this.for_who_tags.forEach(function (item) {
                                var found = result.tags.find(function (t) {
                                    return t.exist && t.name == item;
                                });
                                if (found) _this.data().user['for_who'](item);
                            });
                            _this.games_tags.forEach(function (item) {
                                var found = result.tags.find(function (t) {
                                    return t.exist && t.name == item;
                                });
                                if (found) {
                                    if (_this.data().user['active_games']) _this.data().user['active_games'].push(item);else _this.data().user['active_games'] = [item];
                                }
                            });
                        });
        ...
        this.popupVm = {
            opened: _knockout2.default.observable(false),
            months: _knockout2.default.observableArray([undefined, { index: 1, name: 'Январь' }, { index: 2, name: 'Февраль' }, { index: 3, name: 'Март' }, { index: 4, name: 'Апрель' }, { index: 5, name: 'Май' }, { index: 6, name: 'Июнь' }, { index: 7, name: 'Июль' }, { index: 8, name: 'Август' }, { index: 9, name: 'Сентябрь' }, { index: 10, name: 'Октябрь' }, { index: 11, name: 'Ноябрь' }, { index: 12, name: 'Декабрь' }]),
            step: _knockout2.default.observable(1),
            games: this.games_tags,
            is_register: _knockout2.default.observable(false),
            active_games: _knockout2.default.observableArray([]),
            getField: function getField(field, arr) {
                if (!_this.data()) return '';
                if (!_this.data().user[field]) {
                    if (arr) _this.data().user[field] = _knockout2.default.observableArray([]);else _this.data().user[field] = _knockout2.default.observable();
                }

                // custom_vars validation
                if (field == 'child_bday') _this.data().user[field].extend({ min: 1, max: 31, pattern: { message: "wrong", params: '^[0-9]{1,2}$' } });
                if (field == 'child_byear') _this.data().user[field].extend({ min: 1863, pattern: { message: "wrong", params: '^[0-9]{4}$' } });
                if (field == 'city') _this.data().user[field].extend({ required: true });
                if (field == 'address') _this.data().user[field].extend({ required: true });

                return _this.data().user[field];
            },
            width: _knockout2.default.observable('356px'),
            ...
            next: function next() {
                if (_this.popupVm.step() == 1) {
                    if (!_this.data().user.first_name.isValid()) return;
                    if (!_this.data().user.last_name.isValid()) return;
                    if (!_this.data().user.middle_name.isValid()) return;
                    if (!_this.data().user.birth_day.isValid()) return;
                    if (!_this.data().user.birth_month.isValid()) return;
                    if (!_this.data().user.birth_year.isValid()) return;
                }

                if (_this.popupVm.step() == 2) {
                    if (!_this.data().user.child_bday.isValid()) return;
                    if (!_this.data().user.child_byear.isValid()) return;
                }

                _this.popupVm.step(_this.popupVm.step() + 1);
                if (_this.popupVm.step() == 2) _this.popupVm.width('650px');else _this.popupVm.width('356px');
            },

            finish: function finish() {
                var obj = { auth_hash: _this.config.auth_hash };

                var user = _knockout2.default.toJS(_this.data().user),
                    primary = _extends({}, obj),
                    secondary = _extends({}, obj);
                ...
                if (user.birth_day && user.birth_month && user.birth_year) primary['birthDate'] = user.birth_year + '-' + user.birth_month.index + '-' + user.birth_day;

                if (user.child_bday && user.child_bmonth && user.child_byear) secondary['child_birthdate'] = user.child_byear + '-' + user.child_bmonth.index + '-' + user.child_bday;

                var current_tags = [].concat(user.for_who, user.training, _this.popupVm.active_games(), _this.registration);
                var all_tags = [].concat(_this.training_tags, _this.games_tags, _this.for_who_tags);
                var diff_tags = arr_diff(current_tags, all_tags);

                var thirty = _extends({}, obj, { lang: 'ru', tags: current_tags.join(',') || [] });
                var tags_to_process = [];
                while (diff_tags.length) {
                    tags_to_process.push(diff_tags.pop());
                    if (tags_to_process.length == 10 || !diff_tags.length) {
                        _sailplayHub2.default.jsonp.get(_this.config.DOMAIN + _this.config.urls.tags.delete, {
                            auth_hash: _this.config.auth_hash,
                            lang: 'ru',
                ...
                _this.vars.forEach(function (item) {
                    if (user[item]) secondary[item] = user[item];
                });

                _sailplayHub2.default.jsonp.get(_this.config.DOMAIN + '/js-api/' + _this.config.partner.id + '/users/update/', primary);
                _sailplayHub2.default.jsonp.get(_this.config.DOMAIN + _this.config.urls.users.custom_variables.add, secondary);
                _sailplayHub2.default.jsonp.get(_this.config.DOMAIN + _this.config.urls.tags.add, thirty);
...
},{"knockout":4,"sailplay-hub":7}],13:[function(require,module,exports){
'use strict';
...
exports.default = function (messager) {
    return function (params) {
        ...
        this.actions = _knockout2.default.observableArray([]);
        this.isAction = function (action, name) {
            if (action.action) return action.action == name;else return action.type == name;
        };

        this.perform = function (action) {
            _sailplayHub2.default.send('actions.perform', action);
        };

        _sailplayHub2.default.on('actions.perform.complete', function (data) {
            setTimeout(function () {
                messager.publish(_this.config, 'init');
            }, 500);
        });

        messager.subscribe('init', function (config) {
            _this.config = config;
            _sailplayHub2.default.send('load.actions.list');
            _sailplayHub2.default.on('load.actions.list.success', function (data) {
...
require('sailplay-hub-actions');

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

},{"knockout":4,"sailplay-hub":7,"sailplay-hub-actions":6}],14:[function(require,module,exports){
'use strict';
...
exports.default = function (messager) {
    return function (params) {
        ...
        _sailplayHub2.default.on('load.badges.list.success', function (result) {
            result.multilevel_badges.forEach(function (arr) {
                var temp = [].concat(arr);
                if (arr[0].name == 'Участник') _this.statuses(temp.reverse());
            });
        });

        this.popupVm = {
            messages: this.messages,
            index: _knockout2.default.observable(),
            status: _knockout2.default.observable(),
            opened: _knockout2.default.observable(false),
            width: _knockout2.default.observable('660px'),
            openStatus: function openStatus(status, index) {
                document.body.className += ' no_scrol';
                _this.popupVm.status(status);
                _this.popupVm.index(index());
                _this.popupVm.opened(true);
            }
        };
...
},{"knockout":4,"sailplay-hub":7}],15:[function(require,module,exports){
'use strict';
...
exports.default = function () {
    return function (params) {
        ...
        this.tabs = _knockout2.default.observableArray(params.tabs);
        this.currentTabIndex = _knockout2.default.observable(0);
...
},{"knockout":4}],16:[function(require,module,exports){
var _ = require('underscore');
module.exports = {
    "koAchiv": function(obj){
var __t,__p='',__j=Array.prototype.join,print=function(){__p+=__j.call(arguments,'');};
__p+='\n    <!-- ko foreach: achiv -->\n    <a href="#" class="bns_achiv_item" data-bind="css: { act:  is_received }">\n        <img data-bind="attr: { src: thumbs.url_250x250 }" alt="">\n        <span data-bind="text: name"></span>\n    </a>\n    <!-- /ko -->\n';
return __p;
}
};
...
var _components = require('./templates/components.html');
...
var _profileTemplate = require('./components/templates/profile.template.html');

var _profileTemplate2 = _interopRequireDefault(_profileTemplate);

var _historyTemplate = require('./components/templates/history.template.html');

var _historyTemplate2 = _interopRequireDefault(_historyTemplate);

var _tabsTemplate = require('./components/templates/tabs.template.html');

var _tabsTemplate2 = _interopRequireDefault(_tabsTemplate);

var _questTemplate = require('./components/templates/quest.template.html');

var _questTemplate2 = _interopRequireDefault(_questTemplate);

var _giftsTemplate = require('./components/templates/gifts.template.html');

var _giftsTemplate2 = _interopRequireDefault(_giftsTemplate);

var _achivTemplate = require('./components/templates/achiv.template.html');

var _achivTemplate2 = _interopRequireDefault(_achivTemplate);

var _statusTemplate = require('./components/templates/status.template.html');

var _statusTemplate2 = _interopRequireDefault(_statusTemplate);

var _profile = require('./components/profile.js');

var _profile2 = _interopRequireDefault(_profile);

var _history = require('./components/history.js');
...
var _quest = require('./components/quest.js');

var _quest2 = _interopRequireDefault(_quest);

var _gifts = require('./components/gifts.js');

var _gifts2 = _interopRequireDefault(_gifts);

var _achiv = require('./components/achiv.js');

var _achiv2 = _interopRequireDefault(_achiv);
...
var messager = function () {
    var queue = new _knockout2.default.subscribable();
    return {
...
var inited = _knockout2.default.observable(true);
var register = _knockout2.default.components.register;

register('ko-slider', {
    viewModel: function viewModel(params) {
        this.slides = params.slides;
        this.currentSlide = _knockout2.default.observable(0);
    },
    template: _components2.default.koSlider()
});
...
register('ko-popup', {
    ...
    template: _components2.default.koPopup()
});

register('ko-tabs', { viewModel: (0, _tabs2.default)(messager), template: _tabsTemplate2.default.koTabs() });
register('ko-quest', { viewModel: (0, _quest2.default)(messager), template: _questTemplate2.default.koQuest() });
register('ko-profile', { viewModel: (0, _profile2.default)(messager), template: _profileTemplate2.default.koProfile() });
register('ko-history', { viewModel: (0, _history2.default)(messager), template: _historyTemplate2.default.koHistory() });
register('ko-gifts', { viewModel: (0, _gifts2.default)(messager), template: _giftsTemplate2.default.koGifts() });
register('ko-achiv', { viewModel: (0, _achiv2.default)(messager), template: _achivTemplate2.default.koAchiv() });
register('ko-status', { viewModel: (0, _status2.default)(messager), template: _statusTemplate2.default.koStatus() });

_knockout2.default.bindingHandlers.cssVisible = {
    update: function update(element, valueAccessor) {
        var value = valueAccessor();

        if (_knockout2.default.unwrap(value)) element.className += ' show';else element.className = element.className.replace(' show', '');
    }
};

var SailplaySportDepot = function () {
    function SailplaySportDepot(element, params) {
        var _this2 = this;

        _classCallCheck(this, SailplaySportDepot);

        this.vm = {
            landing: _knockout2.default.observable(false),
            toggle_landing: function toggle_landing() {
                _this2.vm.landing(!_this2.vm.landing());
            }
        };
        ...
        element.innerHTML = _main2.default.index();
        _knockout2.default.applyBindings(this.vm, element);

        this.init();
    }

    _createClass(SailplaySportDepot, [{
        key: 'init',
        value: function init() {
            var _this3 = this;

            _sailplayHub2.default.send('init', this.options);
            _sailplayHub2.default.on('init.success', function (config) {
                _this3.config = config;
                _this3.config.auth_hash = _this3.auth_hash;
...
},{"./components/achiv.js":9,"./components/gifts.js":10,"./components/history.js":11,"./components/profile.js":12,"./components/quest.js":13,"./components/status.js":14,"./components/tabs.js":15,"./components/templates/achiv.template.html":16,"./components/templates/gifts.template.html":17,"./components/templates/history.template.html":18,"./components/templates/profile.template.html":19,"./components/templates/quest.template.html":20,"./components/templates/status.template.html":21,"./components/templates/tabs.template.html":22,"./less/main.less":24,"./templates/components.html":25,"./templates/main.html":26,"knockout":4,"knockout-mapping":2,"knockout.validation":3,"sailplay-hub":7}],24:[function(require,module,exports){
...
},{"lessify":5}],25:[function(require,module,exports){
var _ = require('underscore');
module.exports = {
    "koSlider": function(obj){
var __t,__p='',__j=Array.prototype.join,print=function(){__p+=__j.call(arguments,'');};
__p+='\n    <div class="bns_slide_pager" data-bind="foreach: ko.utils.range(1, slides.length), cssVisible: ">\n        <span data-bind="css: { active: $parent.currentSlide() == $data - 1 },\n                                click: function(data, event) { $parent.currentSlide($data - 1) }\n                        ">*</span>\n    </div>\n    <!-- ko foreach: slides, beforeAdd: add -->\n    <div class="bns_info_slide_item" data-bind="style: { backgroundImage: `url(${image})` }, \n                                                cssVisible: $parent.currentSlide() == $index()">\n        <span class="bns_info_slide_head" data-bind="html: header_html"></span>\n        <span class="bns_info_slide_text" data-bind="html: description_html, style: { color: $data.description_color || \'black\' }"></span>\n        <a href="" class="bns_info_slide_linck" data-bind="text: link_text, attr: { href: link_href }"></a>\n        </div>\n        <!-- /ko -->\n';
return __p;
},
    "koPopup": function(obj){
var __t,__p='',__j=Array.prototype.join,print=function(){__p+=__j.call(arguments,'');};
__p+='\n    <div class="bns_overlay" data-bind="css: { show: data.opened }">\n        <div class="bns_overlay_iner" data-bind="style: { width: data.width }">\n            <a href="#" class="bns_close" data-bind="click: closePopup"></a>     \n            <span data-bind="template: { nodes: $componentTemplateNodes, data: data }"></span>       \n        </div>\n    </div>\n';
return __p;
}
};
},{"underscore":8}],26:[function(require,module,exports){
var _ = require('underscore');
module.exports = {
    "index": function(obj){
var __t,__p='',__j=Array.prototype.join,print=function(){__p+=__j.call(arguments,'');};
__p+='\n    <div class="bns_inner_block">\n        <div class="bns_top" data-bind="click: toggle_landing">\n            <span class="bns_top_head">\n                Бонусная программа\n            </span>\n            <div class="bns_top_item">\n                <img src="src/img/top_ic1.png" alt="">\n                <span>Получайте бонусы<br>\n                    за покупки в магазинах<br>\n                    и на сайте СпортDепо</span>\n            </div>\n            <div class="bns_top_item">\n                <img src="src/img/top_ic2.png" alt="">\n                <span>Получайте<br>\n                    персональные<br>\n                    предложения</span>\n            </div>\n            <div class="bns_top_item">\n                <img src="src/img/top_ic3.png" alt="">\n                <span>Тратьте бонусы<br>\n                    на оплату покупок:<br>\n                    1 бонус = 1 рубль</span>\n            </div>\n        </div>\n\n        <div class="bns_text_block" data-bind="visible: landing()">\n            <h2>Клубная программа</h2>\n            <p>\n                Клубная программа СПОРДЕПО – это накопительная бонусная программа, позволяющая ее участникам совершать выгодные покупки в\n                магазинах и на сайте www.sportdepo.ru и пользоваться дополнительными сервисами и привилегиями.\n                <br><br> Чтобы стать участником Клубной программы СПОРДЕПО, необходимо совершить покупку и заполнить анкету\n                в любом магазине розничной сети или пройти регистрацию на сайте.\n            </p>\n            <hr>\n            <h2>Преимущества участника</h2>\n            <ul>\n                <li>значительная выгода при покупке товаров</li>\n                <li>полезные информационные сервисы</li>\n                <li>подарки на день рождения</li>\n                <li>дополнительные привилегии в обслуживании</li>\n                <li>выгодные условия по сервису и ремонту инвентаря</li>\n            </ul>\n            <hr>\n            <h2>Описание преимуществ программы</h2>\n            <p>\n                После регистрации Вы сможете копить и тратить бонусы, получать скидки на сервис и другие привилегии, используя Ваш номер\n                мобильного телефона. При желании Вы сможете бесплатно получить в магазине пластиковую Клубную Карту.\n                <br>\n                <br> Получайте баллы\n                <br> Получайте 1 балл за каждые 20 руб. во всех магазинах СПОРТДЕПО и на сайте www.sportdepo.ru\n                <br>\n                <br> Получайте привилегии\n\n                <br><br>\n                <ul>\n                    <li>Приветственные бонусы – за регистрацию клубной карты мы подарим Вам 500 бонусов!</li>\n                    <li>Получайте баллы в подарок на Ваш день рождения</li>\n                    <li>Участвуйте в акциях – получайте больше баллов</li>\n                    <li>Покупайте больше и переходите на новый уровень</li>\n                </ul>\n                <p><br>Выгода при покупке\n                    <br> Оплачивайте бонусами до 20% стоимости Ваших покупок. 1 бонус = 1 рубль\n                    <br> Дополнительная выгода\n                    <br> Сотни товаров по сниженным ценам</p>\n\n            </p>\n            <hr>\n            <h2>Где получить карту</h2>\n            <p>Карту можно получить бесплатно во всех магазинах СПОРТДЕПО</p>\n            <hr>\n            <h2>Бонусы на День Рождения</h2>\n            <p>\n                Зарегистрируйтесь в Клубной программе сегодня и получите:\n                <br><br>\n            </p>\n            <ul>\n                <li>700 бонусов(1 бонус=1рубль) = 500 приветственных бонусов за регистрацию и</li>\n                <li>200 бонусов за подписку на e-mail</li>\n            </ul>\n\n            <p>\n                <br> Укажите дату своего рождения и мы подарим Вам на день рождения\n            </p>\n            <div class="bns_cake_block">\n                <div class="bns_cake_item">\n                    <div class="bns_cake_item_img">\n                        <img src="src/img/tort1.png" alt="">\n                    </div>\n                    <span class="bns_cake_bal">\n                       <span class="bns_cake_bal_num">\n                        500\n                       </span>\n                    <span class="bns_cake_bal_text">\n                        бонусов\n                       </span>\n                    </span>\n                    <span class="bns_cake_name">\n                       участнику любительского<br>уровня\n                   </span>\n                </div>\n                <div class="bns_cake_item">\n                    <div class="bns_cake_item_img">\n                        <img src="src/img/tort2.png" alt="">\n                    </div>\n                    <span class="bns_cake_bal">\n                       <span class="bns_cake_bal_num">\n                        1000\n                       </span>\n                    <span class="bns_cake_bal_text">\n                        бонусов\n                       </span>\n                    </span>\n                    <span class="bns_cake_name">\n                       обладателю<br>полупрофессиональной карты\n                   </span>\n                </div>\n                <div class="bns_cake_item">\n                    <div class="bns_cake_item_img">\n                        <img src="src/img/tort3.png" alt="">\n                    </div>\n                    <span class="bns_cake_bal">\n                       <span class="bns_cake_bal_num">\n                        2000\n                       </span>\n                    <span class="bns_cake_bal_text">\n                        бонусов\n                       </span>\n                    </span>\n                    <span class="bns_cake_name">\n                       обладателю<br>PRO-карты\n                   </span>\n                </div>\n            </div>\n        </div>\n\n        <div data-bind="visible: !landing()">\n            <div class="bns_info">\n                <div class="bns_info_left">\n                    <div class="bns_info_text" data-bind="component: \'ko-profile\'"></div>\n                    <div class="bns_info_hist" data-bind="component: \'ko-history\'"></div>\n                    <div class="bns_info_slide" data-bind="component: {\n                        name: \'ko-slider\',\n                        params: { slides: slider_items }\n                    }"></div>\n            </div>\n            <div class="bns_info_right" data-bind="component: \'ko-status\'"></div>\n        </div>\n\n        <div class="btn_tab_main" data-bind="component: {\n                name: \'ko-tabs\',\n                params: { tabs: [\n                    {id: \'tab_qust\', description: \'За выполнение заданий вы получите баллы\', name: \'Задания\'},\n                    {id: \'tab_gift\', description: \'Потратьте ваши накопленные баллы на подарки\', name: \'Подарки\'},\n                    {id: \'tab_achiv\', description: \'Полученные вами награды\', name: \'Награды\'}\n                ]}\n                }">\n            <div class="bns_tab bns_tab_qust" data-bind="visible: tabs()[currentTabIndex()].id == \'tab_qust\', component: \'ko-quest\'"></div>\n            <div class="bns_tab bns_tab_gift" data-bind="visible: tabs()[currentTabIndex()].id == \'tab_gift\', component: \'ko-gifts\'"></div> \n            <div class="bns_tab bns_tab_achiv" data-bind="visible: tabs()[currentTabIndex()].id == \'tab_achiv\', component: \'ko-achiv\'"></div>                       \n        </div>\n    </div>\n';
return __p;
}
};
},{"underscore":8}]},{},[23]);
